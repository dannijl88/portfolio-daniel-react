...
export const Footer = () => {
  return (
    <footer className="bg-secondary max-w-[1500px] m-auto dark:bg-slate-100 flex flex-wrap flex-col md:flex-row h-20 rounded-t-xl flex items-center justify-evenly mt-10">
